  ...
  return (
    <Header className={`fixed w-full z-30 top-0 text-white h-[70px] ${homePath ? 'bg-[#0b7b0e]' : 'bg-transparent'}`}>
      ...
      <View className="w-full max-w-7xl  mx-auto flex-row items-center justify-between mt-0 py-[16px]">
        ...
        {!homePath &&
          < Nav className="w-auto mr-4 space-x-4 flex-row lg:flex lg:items-center hidden lg:block  lg:mt-0 bg-white lg:bg-transparent text-white px-4 lg:p-0 z-20" >
            {tabs.map((tab) => {
    ...
    `}        >
        ...
        {homePath &&
          < Nav className={` ${isMobile ? 'hidden' : ''} w-auto mr-4  flex-row lg:flex lg:items-center hidden lg:block lg:mt-0 bg-white lg:bg-transparent text-white px-4 lg:p-0 z-20 absolute right-10`}>
